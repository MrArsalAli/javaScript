...
// <input type="radio" name="status_${record.student_id}" value="Present" ${record.status === 'Present' ? 'checked' : ''}> Present
//                                 <input type="radio" name="status_${record.student_id}" value="Absent" ${record.status === 'Absent' ? 'checked' : ''}> Absent
//                                 <input type="radio" name="status_${record.stu